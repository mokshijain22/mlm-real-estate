...
function Bookings() {
  ...
  }, [status, approvalStatus, projectId, dateFrom, dateTo, search, page]);
                ...
                bookings.map((b) => {
                  ...
                  return (
                    <tr key={b._id}>
                      ...
                      <td><span className="text-uppercase small fw-bold">{b.paymentMode}</span></td>
                      <td>
                        {b.status === "active" ? (
                      ...
                      <td>
                        <Link to={`/agent/bookings/${b._id}`} className="btn btn-soft-primary btn-sm">
                          View
                        </Link>
                      </td>
                    </tr>

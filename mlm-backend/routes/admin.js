...
const financeTdsController = require('../controllers/admin/financeTdsController');
...
router.get('/projects/:id/banks', projectController.banks);
router.get('/projects/:id/banks', projectController.banks);
...
router.get('/projects/:projectId/pricing-rules', pricingRuleController.index);
router.post('/projects/:projectId/pricing-rules', pricingRuleController.store);
router.put('/projects/:projectId/pricing-rules/:id', pricingRuleController.update);
router.delete('/projects/:projectId/pricing-rules/:id', pricingRuleController.remove);
router.get('/projects/:projectId/pricing-rules/check-price', pricingRuleController.checkPrice);
...
router.get('/tree/company', agentController.companyTree);
